// productData.js
// Human-style notes: this file holds a small product catalog used by the modal.
// Add more products following the same shape. Keep keys matching your product ids.
...
window.PRODUCT_DATA = {
  "SkySofa": {
    id: "SkySofa",
    title: "Sky Sofa - Vintage Upholstery",
    price: 12000,
    currency: "EGP",
  ...
  "Chairs+Frame": {
    id: "Chairs+Frame",
    title: "Pair of Italian Armchairs with Frame",
    price: 8000,
    currency: "EGP",
  ...
  "Kitchenware1": {
    id: "Kitchenware1",
    title: "Vintage Kitchenware Set",
    price: 2500,
    currency: "EGP",
    longDescription: "أدوات مطبخ أنتيك تضيف لمسة كلاسيكية إلى ديكور المطبخ.",
    images: ["./Kitchenware/kitchenware1.png"]
  },

  "TableClock": {
    id: "TableClock",
    title: "Antique Table Clock",
    price: 3200,
    currency: "EGP",
  ...
  "MirrorCenterPiece": {
    id: "MirrorCenterPiece",
    title: "Glass Centerpiece with Mirror Base",
    price: 2800,
    currency: "EGP",
  ...
  "BohemianPinkSet": {
    id: "BohemianPinkSet",
    title: "Bohemian Pink Glassware Set",
    price: 3200,
    currency: "EGP",
  ...
  "BlueBohemianCups+Spoons": {
    id: "BlueBohemianCups+Spoons",
    title: "Blue Bohemian Cups with Spoons",
    price: 3500,
    currency: "EGP",
  ...
  "MirrorWithGoblan": {
    id: "MirrorWithGoblan",
    title: "Mirror with Gobelin Tapestry",
    price: 4800,
    currency: "EGP",
  ...
  "2Marble": {
    ...
    "BronzeGirlSculpture": {
    id: "BronzeGirlSculpture",
    title: "Bronze Girl Sculpture",
    price: 4200,
    currency: "EGP",
  ...
  "WoodenAnimals": {
    id: "WoodenAnimals",
    title: "Wooden Animal Sculptures",
    price: 2500,
    currency: "EGP",
